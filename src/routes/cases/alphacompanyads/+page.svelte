...
<main class="case">
  ...
  <ul>
    ...
    <li>Automação e relatórios de performance</li>
    <li>SEO técnico e estratégia de conteúdo</li>
  </ul>

  <h2>Métricas e resultados</h2>
  <p>Principais resultados: melhorias em tempo de carregamento, rastreabilidade de eventos e aumento de conversões (dados sob NDA).</p>
