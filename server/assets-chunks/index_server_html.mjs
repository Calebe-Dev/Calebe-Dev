...
<head><base href="/Calebe-Dev/">
  ...
  <!-- SEO Básico -->
  <meta name="description" content="Desenvolvedor Web especializado em criação de sites, SEO, marketing digital e gestão de redes sociais. Veja meus serviços e entre em contato!">
  <meta name="keywords" content="desenvolvedor web, criação de sites, SEO, marketing digital, redes sociais, UI/UX, acessibilidade digital, social media, frontend, backend">
  <meta name="author" content="CalebeDev">
  ...
  <meta name="twitter:title" content="CalebeDev - Desenvolvedor Web &amp; Marketing Digital">
  <meta name="twitter:description" content="Especialista em desenvolvimento web, SEO e marketing digital. Confira meus serviços!">
  <meta name="twitter:image" content="URL_DA_IMAGEM_PREVIEW">
